...
export const SolutionExecutionWorkspace: React.FC<SolutionExecutionWorkspaceProps> = ({
  solutionId,
  solution,
  domains,
  subdomains,
  ...
  const [selectedPlatform, setSelectedPlatform] = useState<string>('Zoho Commerce');
  const [operationalRadius, setOperationalRadius] = useState<number>(35);
  const [escrowMode, setEscrowMode] = useState<'2-stage' | '3-stage'>('2-stage');
  ...
  const path = [
    ...
    { id: activeSol?.id || solutionId, name: activeSol?.name || 'Hyperlocal Event & Celebration Marketplace', layer: 5 },
    { id: 'L6-EXECUTION', name: 'Execution Workspace / Control Center', layer: 6 },
  ];
  ...
  const handleCopyBlueprint = () => {
    const blueprintData = {
      ...
      locationContext: activeSol?.locationContext || {
        city: 'Coimbatore',
        state: 'Tamil Nadu',
      ...
      <div className="sticky top-0 z-40 w-full bg-[#020d1a]/95 backdrop-blur-md border-b border-[#00dfff]/20 px-4 sm:px-6 py-2.5 shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {copiedBlueprint ? <Check className="w-3.5 h-3.5" /> : <Copy className="w-3.5 h-3.5" />}
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#03192d] via-[#021323] to-[#010c17] border border-[#00dfff]/25 p-5 sm:p-6 shadow-xl">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-[#9bd5e8] max-w-3xl leading-relaxed">
                Direct control center for configuring multi-seller business rules, testing geospatial provider matching, simulating live event reservation pipelines, and monitoring settlement telemetry.
              </p>
            </div>
            ...
            <div className="shrink-0 flex items-center gap-3">
              <div className="p-3 rounded-xl bg-[#020f1c] border border-[#00dfff]/20 text-center font-mono">
                ...
                <div className="text-xs font-bold text-[#00e3fd]">Interactive Sandbox</div>
              </div>
              <div className="p-3 rounded-xl bg-[#020f1c] border border-[#00dfff]/20 text-center font-mono">
                <div className="text-[10px] uppercase text-[#6e9bb3]">Health</div>
          ...
          <div className="mt-4 pt-3 border-t border-[#00dfff]/15 flex flex-wrap items-center justify-between text-[11px] font-mono text-[#82a5bb] gap-2">
            <div className="flex items-center gap-1.5">
              ...
              <span>Sandbox execution verified against AAi Canonical Capability Schema. Production deployment routes to live cloud containers.</span>
            </div>
            <div className="text-[#00dfff]">
              Location Anchor: {activeSol.locationContext?.city || 'Coimbatore'}, {activeSol.locationContext?.state || 'Tamil Nadu'}
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 border-b border-[#00dfff]/15 scrollbar-thin">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <Icon className={`w-3.5 h-3.5 ${isActive ? 'text-[#020914]' : 'text-[#00dfff]'}`} />
                <span>{tab.label}</span>
              </button>
            );
          })}
            ...
            <div className="lg:col-span-2 space-y-5">
              <div className="p-5 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono">
                  <div className="p-3 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                    <span className="text-[#6e9bb3] block text-[11px]">Primary Capability Domain</span>
                    <strong className="text-[#eaf7ff] text-sm">D06 Marketplace & Commerce</strong>
                    <span className="text-[#00dfff] block text-[11px] mt-1">D06.01 Hyperlocal Marketplace</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                    <span className="text-[#6e9bb3] block text-[11px]">Parent Solution Bundle</span>
                    <strong className="text-[#eaf7ff] text-sm">D06.01.01.01</strong>
                    <span className="text-[#00dfff] block text-[11px] mt-1">Event Management & Booking Bundle</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                    <span className="text-[#6e9bb3] block text-[11px]">Process & Settlement Engine</span>
                    <strong className="text-[#eaf7ff] text-sm">Multi-Party Escrow (UPI/Stripe)</strong>
                    <span className="text-[#00dfff] block text-[11px] mt-1">{escrowMode.toUpperCase()} milestone verification</span>
                  </div>
                  <div className="p-3 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                    <span className="text-[#6e9bb3] block text-[11px]">Geofence Radius Enforcement</span>
                    <strong className="text-[#eaf7ff] text-sm">{operationalRadius} km Operating Zone</strong>
                    <span className="text-[#00dfff] block text-[11px] mt-1">Anchor: Coimbatore Urban & Suburban</span>
                  </div>
                </div>

                <p className="text-xs text-[#9bd5e8] leading-relaxed pt-2">
                  The Hyperlocal Event Marketplace combines real-time venue floorplan scheduling, custom multi-item gourmet catering quotes, professional sound/stage dispatch, and wedding photography crews into a unified customer checkout with automated split settlements.
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-4">
                <div className="flex items-center justify-between pb-3 border-b border-[#00dfff]/15">
                  ...
                  <span className="text-xs font-mono text-[#00dfff]">6 Lifecycle Steps</span>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs">
                  {[
                    { step: '01', name: 'Discovery', desc: 'Customer selects date & guest count within 35km' },
                    { step: '02', name: 'Inquiry Broadcast', desc: 'Geofence matches verified banquet & caterers' },
                    { step: '03', name: 'Quote Mesh', desc: 'Custom per-plate & AV quotation compiled' },
                    { step: '04', name: 'Escrow Lock', desc: '30% deposit secured in platform escrow' },
                    { step: '05', name: 'Milestone OTP', desc: 'Hall entry check-in verifies vendor arrival' },
                    { step: '06', name: 'Split Settlement', desc: 'Balances auto-released to vendor UPI wallets' },
                  ].map((s) => (
                    <div
                      key={s.step}
                    ...
                    >
                      <div>
                        <span className="font-mono text-xs font-bold text-[#00e3fd]">{s.step}</span>
                        <strong className="block text-[#eaf7ff] mt-1 font-semibold">{s.name}</strong>
                        <p className="text-[11px] text-[#82a5bb] mt-1 leading-relaxed">{s.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-5">
              <div className="p-5 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-4">
                ...
                <div className="space-y-3 text-xs font-mono">
                  <div>
                    <label className="text-[#82a5bb] block mb-1">Commerce Adapter</label>
                    <select
                    ...
                    >
                      <option value="Zoho Commerce">Zoho Commerce (Native ERP Sync)</option>
                      <option value="Shopify">Shopify (App Bridge + GraphQL)</option>
                      <option value="Magento / Adobe Commerce">Magento / Adobe Commerce (MSI)</option>
                  ...
                  <div>
                    <div className="flex justify-between text-[#82a5bb] mb-1">
                      ...
                      <span className="text-[#00e3fd] font-bold">{operationalRadius} km</span>
                    </div>
                    <input
                      type="range"
                      min="5"
                      ...
                      onChange={(e) => setOperationalRadius(Number(e.target.value))}
                  ...
                  <div>
                    <div className="flex justify-between text-[#82a5bb] mb-1">
                      ...
                      <span className="text-[#00e3fd] font-bold">{commissionRate}%</span>
                    </div>
                    <input
                      type="range"
                      min="2"
              ...
              <div className="p-5 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-3 font-mono text-xs">
                ...
                {[
                  { label: 'Geospatial Grid Service', status: 'Active (35ms)', ok: true },
                  { label: 'Quotation Decomposition', status: 'Active (12ms)', ok: true },
                  { label: 'Escrow Ledger Engine', status: 'Active (28ms)', ok: true },
                  { label: 'Platform Connector Bridge', status: `${selectedPlatform} Ready`, ok: true },
                  { label: 'SMS & WhatsApp OTP Relay', status: 'Connected', ok: true },
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center justify-between py-1 border-b border-[#00dfff]/10">
          ...
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[#82a5bb] mt-0.5">
                  Tune platform adapters, commission rules, geographic boundary thresholds, and escrow release gates.
                </p>
              </div>
              <button
                onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <strong className="text-sm text-[#eaf7ff] font-mono block">1. Commerce Engine Adapter</strong>
                <p className="text-xs text-[#82a5bb]">
                  Select the host commerce infrastructure to sync vendor products, orders, and payment webhooks.
                </p>
                <div className="grid grid-cols-2 gap-2 text-xs font-mono">
                  {['Zoho Commerce', 'Shopify', 'Magento / Adobe Commerce', 'OpenCart'].map((plat) => (
                    <button
                      key={plat}
                    ...
                    >
                      ...
                      <span className="text-[10px] text-[#6e9bb3] block mt-1">
                        {plat === 'Zoho Commerce' ? 'Zoho Books + Inventory' : 'GraphQL Webhook Sync'}
                      </span>
                    </button>
                  ))}
                </div>
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <strong className="text-sm text-[#eaf7ff] font-mono block">2. Escrow & Settlement Structure</strong>
                <p className="text-xs text-[#82a5bb]">
                  Control how customer funds are locked and dispersed across multi-seller event bookings.
                </p>
                <div className="space-y-2 text-xs font-mono">
                  <label className="flex items-center gap-2 p-2.5 rounded-lg bg-[#020e1a] border border-[#00dfff]/20 cursor-pointer">
                    ...
                    />
                    <div>
                      <strong className="text-[#eaf7ff] block">2-Stage Settlement (Standard)</strong>
                      <span className="text-[#82a5bb] text-[11px]">30% deposit held on booking, 70% released after hall check-in OTP.</span>
                    </div>
                  </label>
                  <label className="flex items-center gap-2 p-2.5 rounded-lg bg-[#020e1a] border border-[#00dfff]/20 cursor-pointer">
                    <input
                    ...
                    />
                    <div>
                      <strong className="text-[#eaf7ff] block">3-Stage Milestone Settlement</strong>
                      <span className="text-[#82a5bb] text-[11px]">25% on reservation, 50% on event morning, 25% post-event signoff.</span>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <strong className="text-sm text-[#eaf7ff] font-mono block">3. Geospatial Radius Limit</strong>
                <p className="text-xs text-[#82a5bb]">
                  Define maximum distance from Coimbatore center to match caterers, florists, and AV sound operators.
                </p>
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <strong className="text-sm text-[#eaf7ff] font-mono block">4. Vendor Onboarding Verification</strong>
                <p className="text-xs text-[#82a5bb]">
                  Minimum KYC standards required for local vendors to receive quotation requests.
                </p>
                <div className="flex items-center gap-3 font-mono text-xs">
                  ...
                  >
                    Standard KYC
                    <span className="block text-[10px] text-[#6e9bb3] mt-0.5">PAN + Bank Details</span>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <span className="block text-[10px] text-[#6e9bb3] mt-0.5">GST + Trade License + Inspection</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[#82a5bb] mt-0.5">
                  Logical topology representing service boundaries, APIs, and synchronous event queues.
                </p>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-[#010b14] border border-[#00dfff]/20 font-mono">
              <div className="text-center text-xs text-[#00e3fd] font-bold mb-4 uppercase tracking-widest">
                Client Layer → API Gateway → Domain Services → Persistence & Escrow
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-xs">
                ...
                <div className="p-4 rounded-xl bg-[#031b31]/70 border border-[#00dfff]/20 space-y-2">
                  ...
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Web & Mobile PWA</strong>
                    <span className="text-[10px] text-[#6e9bb3]">React + Tailwind Client</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Vendor Partner Portal</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Quotation & Slot Manager</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#031b31]/70 border border-[#00dfff]/20 space-y-2">
                  ...
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">AAi Intent Gateway</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Auth & Request Throttling</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Geospatial Router</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Radius query (PostGIS / Haversine)</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#031b31]/70 border border-[#00dfff]/20 space-y-2">
                  ...
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Venue Slot Engine</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Real-time calendar lock</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Catering RFQ Mesh</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Dynamic menu quoter</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">AV / Media Dispatch</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Rider & crew scheduler</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#031b31]/70 border border-[#00dfff]/20 space-y-2">
                  ...
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Escrow Split Ledger</strong>
                    <span className="text-[10px] text-[#6e9bb3]">Multi-vendor UPI split</span>
                  </div>
                  <div className="p-2.5 rounded-lg bg-[#02101e] border border-[#00dfff]/15">
                    <strong className="text-[#eaf7ff] block">Platform Adapter</strong>
                    <span className="text-[10px] text-[#6e9bb3]">{selectedPlatform} Integration</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'composition' && (
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15">
              ...
              <p className="text-xs text-[#82a5bb] mt-0.5">
                Every modular service that makes up D06.01.01.01.001 with integration contracts and readiness states.
              </p>
            </div>
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <strong className="text-sm font-bold text-[#eaf7ff] block">{svc.name}</strong>
                    <p className="text-xs text-[#82a5bb] mt-1 leading-relaxed">{svc.desc}</p>
                  </div>
          ...
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-[#82a5bb] mt-0.5">
                  Verified vendor partners in the Coimbatore & South India regional service zone.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                >
                  <div>
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      <span className="text-xs font-mono text-[#00dfff] font-bold">{provider.category}</span>
                      <span className="text-xs font-mono text-emerald-400 flex items-center gap-1 font-bold">
                        <CheckCircle2 className="w-3.5 h-3.5" /> {provider.status}
                      </span>
                    </div>
                    <strong className="text-sm text-[#eaf7ff] block font-bold">{provider.name}</strong>
                    <div className="flex items-center gap-1.5 text-xs text-[#6e9bb3] mt-1 font-mono">
                      <MapPin className="w-3.5 h-3.5 text-[#00e3fd]" />
                      <span>{provider.location}</span>
                    </div>
                    <p className="text-xs text-[#82a5bb] mt-1.5">{provider.specs}</p>
                  </div>
                  <div className="mt-3 pt-2 border-t border-[#00dfff]/10 flex items-center justify-between text-xs font-mono">
                    <span className="text-amber-400 font-bold">★ {provider.rating} / 5.0</span>
                    <span className="text-[#00e3fd] font-bold">{provider.pricing}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {activeTab === 'location' && (
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15">
              ...
              <p className="text-xs text-[#82a5bb] mt-0.5">
                Active geo-coordinates, pincode coverage clusters, and cross-district corridors.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-2">
                <span className="text-xs font-mono text-[#00dfff] font-bold block">Primary Urban Hub</span>
                <strong className="text-base text-[#eaf7ff] block">Coimbatore Central Hub</strong>
                <p className="text-xs text-[#82a5bb]">
                  Core metropolitan coverage including RS Puram, Gandhipuram, Peelamedu, Race Course, and Saravanampatti.
                </p>
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-2">
                <span className="text-xs font-mono text-[#00dfff] font-bold block">Suburban Expansion Corridor</span>
                <strong className="text-base text-[#eaf7ff] block">Pollachi & Tiruppur Belt</strong>
                <p className="text-xs text-[#82a5bb]">
                  High-capacity destination wedding venues, agricultural event lawns, and textile convention facilities within 45km.
                </p>
                <div className="pt-2 text-[11px] font-mono text-[#6e9bb3]">
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-2">
                <span className="text-xs font-mono text-[#00dfff] font-bold block">South Coastal Sister Hub</span>
                <strong className="text-base text-[#eaf7ff] block">Kanyakumari Coastal Zone</strong>
                <p className="text-xs text-[#82a5bb]">
                  Specialized coastal sound production, beachfront wedding venues, and regional audio-visual technician roster.
                </p>
                <div className="pt-2 text-[11px] font-mono text-[#6e9bb3]">
            ...
            <div className="p-5 rounded-2xl bg-[#010a14] border border-[#00dfff]/20 text-center font-mono">
              <div className="flex items-center justify-between text-xs text-[#6e9bb3] mb-3">
                ...
                <span className="text-[#00e3fd]">Active Radius: {operationalRadius}km Ring</span>
              </div>
              <div className="h-44 rounded-xl bg-gradient-to-b from-[#021323] to-[#010810] border border-[#00dfff]/15 relative overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <span className="text-xs font-bold text-[#eaf7ff] mt-2">Coimbatore HQ</span>
                  <span className="text-[10px] text-[#00dfff]">11.0168° N, 76.9558° E</span>
                </div>
          ...
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[#82a5bb] mt-0.5">
                  Live multi-seller slot locking, collision detection, and instant session holds.
                </p>
              </div>
              <span className="text-xs font-mono text-[#00dfff] bg-[#00dfff]/10 px-2 py-1 rounded border border-[#00dfff]/20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2.5 font-mono text-xs">
              {[
                { day: 'Mon, Oct 12', morning: 'Available', evening: 'Booked', date: '12' },
                { day: 'Tue, Oct 13', morning: 'Available', evening: 'Available', date: '13' },
                { day: 'Wed, Oct 14', morning: 'Inquiry Lock', evening: 'Available', date: '14' },
                { day: 'Thu, Oct 15', morning: 'Available', evening: 'Booked', date: '15' },
                { day: 'Fri, Oct 16', morning: 'Booked', evening: 'Booked', date: '16' },
                { day: 'Sat, Oct 17', morning: 'Booked', evening: 'Booked', date: '17' },
                { day: 'Sun, Oct 18', morning: 'Booked', evening: 'Inquiry Lock', date: '18' },
              ].map((slot, idx) => (
                <div
                  key={idx}
                ...
                >
                  <div className="text-center pb-1 border-b border-[#00dfff]/10">
                    <span className="text-[#82a5bb] text-[10px] block">{slot.day}</span>
                    <strong className="text-lg text-[#eaf7ff]">{slot.date}</strong>
                  </div>
          ...
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-[#82a5bb] mt-0.5">
                  Walk through the entire transaction lifecycle from user booking inquiry to automated escrow payout.
                </p>
              </div>
              <div className="flex items-center gap-2">
                <button
              ...
              {[
                {
                  ...
                  detail: 'Client specifies: Wedding Reception | Date: Oct 18 PM | Guest Count: 500 | Radius: Coimbatore 35km.',
                  status: simulationStep >= 1 ? 'COMPLETED' : 'PENDING',
                },
                {
                  step: 2,
                  title: 'Step 2: Geospatial Geofence Query & Provider Matching',
                ...
                {
                  step: 3,
                  title: 'Step 3: Multi-Party RFQ Compilation & Unified Price Card',
                  detail: 'Automated itemized quotation generated: Venue (₹85k) + Gourmet Catering (₹1.75L) + Sound/Light (₹35k) + Photo (₹60k). Total: ₹3.55 Lakhs.',
                ...
                },
                {
                  ...
                  detail: 'Calendar locks confirmed. Customer and vendor receive event day check-in OTP for arrival validation.',
                  status: simulationStep >= 5 ? 'COMPLETED' : 'PENDING',
                },
                {
                  step: 6,
                  title: 'Step 6: Event Completion & Automated Split Settlement',
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <strong
                      className={`text-xs font-bold ${
                        simulationStep >= item.step ? 'text-[#eaf7ff]' : 'text-[#82a5bb]'
                      }`}
                    >
                      {item.title}
                    </strong>
                    ...
                    >
                      {simulationStep === item.step ? 'RUNNING...' : item.status}
                    </span>
                  </div>
        ...
        {activeTab === 'monitoring' && (
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15">
              ...
              <p className="text-xs text-[#82a5bb] mt-0.5">
                Key performance indicators for the Hyperlocal Event Marketplace reference architecture.
              </p>
            </div>

            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 font-mono">
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                <span className="text-[11px] text-[#6e9bb3] uppercase block">Provider Matching Latency</span>
                <strong className="text-2xl text-[#00e3fd] font-bold block mt-1">42 ms</strong>
                <span className="text-[10px] text-emerald-400">Within &lt; 50ms SLA target</span>
              </div>

              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                <span className="text-[11px] text-[#6e9bb3] uppercase block">Quotation Generation</span>
                <strong className="text-2xl text-[#00e3fd] font-bold block mt-1">1.2 sec</strong>
                <span className="text-[10px] text-emerald-400">Multi-seller price assembly</span>
              </div>

              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                <span className="text-[11px] text-[#6e9bb3] uppercase block">Escrow Ledger Accuracy</span>
                <strong className="text-2xl text-emerald-400 font-bold block mt-1">100.0%</strong>
                <span className="text-[10px] text-[#6e9bb3]">Zero reconciliation drift</span>
              </div>

              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15">
                <span className="text-[11px] text-[#6e9bb3] uppercase block">Active Service Uptime</span>
                <strong className="text-2xl text-emerald-400 font-bold block mt-1">99.98%</strong>
                <span className="text-[10px] text-[#6e9bb3]">High-availability multi-zone</span>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'next_steps' && (
          <div className="p-6 rounded-2xl bg-[#021323]/90 border border-[#00dfff]/20 space-y-6 animate-in fade-in">
            <div className="pb-3 border-b border-[#00dfff]/15">
              ...
              <p className="text-xs text-[#82a5bb] mt-0.5">
                Clearly distinguishes available sandbox configuration from future operational deployment phases.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <div className="flex items-center justify-between">
                  <strong className="text-sm text-[#eaf7ff]">1. Export Architecture Spec</strong>
                  <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 font-bold">
                    AVAILABLE NOW
                  </span>
                </div>
                <p className="text-[#82a5bb] leading-relaxed">
                  Download the complete JSON manifest specifying all 6 layers of the Hyperlocal Event Marketplace, platform adapter mappings, and escrow configurations.
                </p>
                <button
                  onClick={handleCopyBlueprint}
              ...
              <div className="p-4 rounded-xl bg-[#031b31]/60 border border-[#00dfff]/15 space-y-3">
                <div className="flex items-center justify-between">
                  <strong className="text-sm text-[#eaf7ff]">2. Live Container Deployment</strong>
                  <span className="text-[10px] px-2 py-0.5 rounded bg-purple-500/20 text-purple-300 font-bold">
                    FUTURE CAPABILITY
                  </span>
                </div>
                <p className="text-[#82a5bb] leading-relaxed">
                  Direct provisioning to Cloud Run with attached PostgreSQL database, Redis session buffer, and production Zoho/Shopify webhook credentials.
                </p>
                <button
                  disabled
            ...
            <div className="p-4 rounded-xl bg-[#020f1c] border border-[#00dfff]/20 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono">
              <div>
                <strong className="text-[#eaf7ff] block">Finished with Execution Workspace?</strong>
                <span className="text-[#82a5bb]">
                  Step back to L5 (Understand Solution) or return to the AAi Universe galaxy map.
                </span>
              </div>
              <div className="flex items-center gap-2">
                <button
