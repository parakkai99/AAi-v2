...
export default function SpatialActivityRail({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-1.5 rounded-2xl border border-white/10 bg-black/30 p-1.5 shadow-2xl backdrop-blur-md">
            ...
            <button
              ...
              className={[
                ...
                selected
                  ...
                  : "border-transparent text-white/55 hover:border-white/15 hover:bg-white/10 hover:text-white",
              ].join(" ")}
            >
      ...
      {active && (
        <div className="absolute right-12 top-1/2 w-64 -translate-y-1/2">
          <div className="rounded-2xl border border-white/10 bg-[#03162b]/95 p-4 text-white shadow-2xl backdrop-blur-xl">
